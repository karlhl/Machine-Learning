...
def load_cora():
    ...
    labels = np.empty((num_nodes,1), dtype=np.int64) # 生成大小，不进行初始化
    node_map = {}
    # 统计所有标签
    label_map = {}
    with open("../cora/cora.content") as fp:
        for i,line in enumerate(fp):
            ...
            # 对info第一列的id进行顺序编码，node_map用于建立索引
            node_map[info[0]] = i
...
def run_cora():
    ...
    feat_data, labels, adj_lists = load_cora() # feat_data:(2708,1433),labels:(2708,1),adj_lists:(2708长的dict)
