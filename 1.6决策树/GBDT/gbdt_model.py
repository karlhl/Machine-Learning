...
from sklearn.model_selection import train_test_split, standardize, to_categorical
from sklearn.model_selection import mean_squared_error, accuracy_score
...
class GBDT(object):
    ...
    def __init__(self, n_estimators, learning_rate, min_samples_split,
        ...
        self.min_samples_split = min_samples_split # 每科子树的节点的最小数目
        self.min_impurity = min_impurity # 每颗子树的最小纯度
        self.max_depth = max_depth # 每颗子树的最大层数
        self.regression = regression #  日否为回归问题
